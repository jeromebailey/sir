          ...
          <div class="x_content">
            ...
            <div class="row">
              <div class="col-md-2 col-md-offset-9">
                <button class="btn btn-lg btn-danger" name="btnPrint" id="btnPrint"><i class="fa fa-print"></i> Print Quote</button>
              </div>
            </div>
            ...
            <br />
              ...
              <div class="row">
                ...
                <div class="col-md-4 col-md-offset-3 pull-right">                  
                    <label for="po-no-id">Quote No.:</label> <?=$quote["quote_no"];?>
                  
                    <br />
                    <label for="requisition-date">Date:</label>
                    <?=date('M d, Y', strtotime($quote["quote_date"]));?>
                ...
                <div class="col-md-12">
                  <table class="table table-bordered table-striped table-condensed" id="tblRequestedItems">
                    ...
                    <tr>
                      <td colspan="2"></td>
                      <td>Total</td>
                      <td><?= '$' . number_format($quote["quote_total_amount"], 2, '.', ',');?></td>
                    </tr>
                  </table>
                </div>
              </div>
