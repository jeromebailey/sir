      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
            ...
            <form method="post" id="frm" data-toggle="validator" role="form" action="<?=base_url('Reports/do_search_inventory_category_item_level_cost_by_date_range')?>">
              ...
              <table class="table table-striped table-hover table-bordered" id="data-table">
                ...
                <tbody>
                  <?
                  if( empty($inventory_category_log) ){?>
                    <tr>
                  ...
                  <?} else {
                    //echo "<pre>";print_r($all_users);exit;
                      ...
                      $selected_column_data = json_decode($inventory_category_log[0]["column_data"]);
