...
<html lang="en">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
            ...
            <form id="add-user-frm" class="form-horizontal form-label-left" method="post" action="<?=base_url('Invoices/do_edit_ba_type_invoice')?>" data-toggle="validator" role="form">
    ...
    <script type="text/javascript">
      ...
      bf_counter = ($('#tblRequestedItems #bf >tr').length == 1) ? 1 : $('#tblRequestedItems #bf >tr').length+1;
      cc_counter = ($('#tblRequestedItems #cc >tr').length == 1) ? 1 : $('#tblRequestedItems #cc >tr').length+1;
      entree_counter = ($('#tblRequestedItems #entree >tr').length == 1) ? 1 : $('#tblRequestedItems #entree >tr').length+1;
      cw_counter = ($('#tblRequestedItems #cw >tr').length == 1) ? 1 : $('#tblRequestedItems #cw >tr').length+1;
      ii_counter = ($('#tblRequestedItems #ii >tr').length == 1) ? 1 : $('#tblRequestedItems #ii >tr').length+1;
      retro_counter = ($('#tblRequestedItems #retro >tr').length == 1) ? 1 : $('#tblRequestedItems #retro >tr').length+1;
      wt_counter = ($('#tblRequestedItems #wt >tr').length == 1) ? 1 : $('#tblRequestedItems #wt >tr').length+1;
      wtp_counter = ($('#tblRequestedItems #wtp >tr').length == 1) ? 1 : $('#tblRequestedItems #wtp >tr').length+1;
      misc_counter = ($('#tblRequestedItems #misc >tr').length == 1) ? 1 : $('#tblRequestedItems #misc >tr').length+1;
