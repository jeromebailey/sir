      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
            ...
            <form id="add-user-frm" class="form-horizontal form-label-left" method="post" action="<?=base_url('PurchaseOrders/do_duplicate_purchase_order')?>" data-toggle="validator" role="form">
                  ...
                  <select id="client-id" name="client-id" class="form-control" required="required">
                    ...
                    if( !empty($clients) ){
                      foreach ($clients as $key => $value) {
                        if( $purchase_order["client_id"] == $value["client_id"] ){?>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="control-label col-md-4 col-sm-12 col-xs-12" for="po-date">Date:</label>
                        <div class="col-md-8 col-sm-12 col-xs-12" style="margin-top: 7px;">
                          <?=date('d-M-Y');?>
                          <input type="hidden" name="po-date" value="<?=date('d-M-Y');?>" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row">
                <div class="dol-md-4">
                  <button type="submit" class="btn btn-lg btn-success" style="margin-top: 23px;">Create Purchase Order From Duplicate
