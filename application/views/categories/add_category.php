        ...
        <div class="right_col" role="main">
          ...
          <div class="x_content">
            ...
            <h3><?=$page_title;?> <i class="fas fa-box"></i></h3>
              ...
              <form id="demo-form2" data-toggle="validator" class="form-horizontal form-label-left" method="post" action="<?=base_url('Categories/do_add_category');?>">
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="category-name" name="category-name" required="required" autocomplete="off" class="form-control col-md-7 col-xs-12">
                  </div>
                </div>
